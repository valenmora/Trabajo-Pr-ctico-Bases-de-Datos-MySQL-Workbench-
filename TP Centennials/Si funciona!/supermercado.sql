...
insert into Sucursales (codigo_sucursal, barrio, direccion) values (1004, 'San Cristóbal' , 'Av. Independencia 2262') ;
insert into Sucursales (codigo_sucursal, barrio, direccion) values (1005, 'Almagro' , 'Río de Janeiro 844') ;
insert into Sucursales (codigo_sucursal, barrio, direccion) values (1006, 'Caballito' , 'Otamendi 443') ;
insert into Sucursales (codigo_sucursal, barrio, direccion) values (1007, 'San Nicolás' , 'Tte. Gral. Juan Domingo Perón 1653') ;
